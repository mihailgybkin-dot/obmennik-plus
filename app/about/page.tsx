    ...
    <main>
      ...
      <div className="mx-auto max-w-4xl px-4 pt-28 pb-16 space-y-8">
        ...
        <section className="card p-6 space-y-3">
          <p>Мы — команда профессионалов с опытом в офлайн-обменах и блокчейн-операциях. Наш фокус — быстрые сделки в Краснодаре с прозрачными условиями.</p>
        </section>

        <section className="grid md:grid-cols-2 gap-4">
          <div className="card p-6">
            <div className="text-lg font-semibold mb-1">Поддержка 24/7</div>
            <p className="opacity-85">Отвечаем в поддержку оперативно, помогаем с заявками и уточнениями.</p>
          </div>
          <div className="card p-6">
          ...
          <div className="card p-6">
            ...
            <p className="opacity-85">Обычно подтверждаем заявку в течение 5–15 минут.</p>
          </div>
          <div className="card p-6">
